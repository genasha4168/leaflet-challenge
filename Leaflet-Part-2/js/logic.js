//----------------------------------------------------------------------------------------------------------------
// Leaflet-Part-2 - Earthquake Map with Tectonic Plates
//----------------------------------------------------------------------------------------------------------------
    ...
    let earthquakes = L.geoJSON(data, {
      pointToLayer: function (feature, latlng) {
        ...
        return L.circleMarker(latlng, {
          ...
          `<strong>Magnitude:</strong> ${mag}<br><strong>Location:</strong> ${place}<br><strong>Depth:</strong> ${depth} km`
        );
      }
    });
...
// Fetch tectonic plate boundary GeoJSON and add to map
fetch("https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json")
  ...
  .then(data => {
    ...
    // Add to LayerGroup
    tectonicPlatesLayer.addLayer(plates);
  });
